<nav class="navbar navbar-expand-lg navbar-dark bg-success" style="background: #00ba8b !important; ">
  <div class="container"> 
    <img class="mr-2 d-none" src="{{ url('/')}}/image/rmutsb_logo_en.png" height="50">
    <img class="mr-2" src="{{ url('/')}}/image/kaset.png" height="50">    
    <img class="mr-2" src="{{ url('/')}}/image/logo_head.png" height="50">   
    <img class="mr-2 d-none" src="{{ url('/')}}/image/swg.png" height="50">
