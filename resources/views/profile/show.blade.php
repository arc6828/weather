                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Role </th><td> {{ $profile->role }} </td></tr><tr><th> User Id </th><td> {{ $profile->user_id }} </td></tr><tr><th> Photo </th><td> {{ $profile->photo }} </td></tr><tr><th> Lineid </th><td> {{ $profile->lineid }} </td></tr>
                                </tbody>
                            </table>
                        </div>
